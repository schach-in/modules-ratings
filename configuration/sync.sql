...
-- verbaende_static2 --
contacts_identifiers[0][identifier_category_id] = /*_ID categories identifiers/pass-dsb _*/;
...
SELECT identifier, contact_id FROM contacts_identifiers WHERE identifier IN ('%s') AND current = 'yes' AND identifier_category_id = /*_ID categories identifiers/pass-dsb _*/;
